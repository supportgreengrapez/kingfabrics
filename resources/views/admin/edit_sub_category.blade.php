      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        @if($result1>0)
                @foreach($result1 as $results)
                    <form method="post" action = "{{url('/')}}/admin/home/edit/sub/category/{{$results->pk_id}}" class="login-form">
                        {{ csrf_field() }}
           @if($errors->any())
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="form-group ">
                ...
                <div class="input-group">
                  ...
                  @if($result1>0)
            @foreach($result1 as $results)
                  <input class="form-control" name="sub_category" value="{{$results->sub_category}}"  type="text"/>
                  @endforeach
       @endif
                </div>
              </div>
