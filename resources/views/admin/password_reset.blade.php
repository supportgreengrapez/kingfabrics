...
<form method="post" action = "{{url('/')}}/admin/password/reset" class="login-form">
  ...
  <strong> {{$errors->first()}}</strong>
	...
	@endif
              ...
              <div class="separator">
                <div>
                  <h1><i><img src="{{URL('/')}}/images/logo.png" alt="KINGFABRICS"></i></h1>
                  <p>Copyright © 2020-2021 KINGFABRICS. All rights reserved.</p>
                  <p>Powered By <a href="https://greengrapez.com">Green Grapez <img src="{{URL('/')}}/images/greengrapez.png" alt="green grapez"></a></p>
                </div>
              </div>
            </form>
          </section>
