			...
			<tr><td>
				<div style="line-height: 24px;">
					...
					<span  style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						  Congratulations! your order just moved from |“Production”| to |“Folding”| Phase. It’s moving up towards completion. We will keep you posted. Keep a lookout in your dashboard for more detailed updates at www.kingfabrics.com.<br>

Here are your Order details as of 02-02-2018
...
<p itemprop="email">Address</p>
                                        ...
                                        <p><span itemprop="affiliation">Status</span></p>
...
<p>{{$customer_address}}</p>
										...
										<p>{{$product_id}}</p>
										<p><strong style="color:#FF0000;">{{$product_previous_status}}</strong> is changed to <strong style="color:#00a65a;">{{$product_current_status}}</strong></p>
                                        <p>{{$product_gsm}}</p>
                                        <p>{{$product_color}}</p>
                                        <p>{{$product_weave}}</p>
                                        <p>{{$product_warp}}</p>
