...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
						...
						<tr><td align="left" valign="middle">
							...
							<table width="115" border="0" cellspacing="0" cellpadding="0" >
								<tr><td align="left" valign="top" class="mob_center">
									...
									<img src="{{URL('/')}}/images/logo.png" width="250" height="35" alt="Metronic" border="0" style="display: block;" /></font></a>
								</td></tr>
							</table>						
						</td></tr>
								...
								<tr><td align="right">
									...
									<table border="0" cellspacing="0" cellpadding="0">
										<tr><td width="30" align="center" style="line-height: 19px;">
											...
											<img src="{{URL('/')}}/images/fb-icon1.png" width="30" height="30" alt="Facebook" border="0" style="display: block;" /></font></a>
										</td><td width="39" align="center" style="line-height: 19px;">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
											<font face="Arial, Helvetica, sans-serif" size="2" color="#596167">
											<img src="{{URL('/')}}/images/twitter-icon1.png" width="30" height="30" alt="Twitter" border="0" style="display: block;" /></font></a>
										</td><td width="29" align="right" style="line-height: 19px;">
											<a href="#" target="_blank" style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
											<font face="Arial, Helvetica, sans-serif" size="2" color="#596167">
											<img src="{{URL('/')}}/images/gp-icon1.png" width="30" height="30" alt="Dribbble" border="0" style="display: block;" /></font></a>
										</td></tr>
									</table>
									</div>
									<!--social END-->
			...
			<tr><td>
				<div style="line-height: 24px;">
					...
					<span  style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">
						We are glad to receive your inquiry. King Fabrics is working 24/7 to process your inquiry and move into the order confirmation phase. You will receive a notification soon in your inbox after reviewing your inquiry. You can review your order at the following link, by signing in with your email and password: <a href="">www.kingfabrics.com/dashboard.html</a>
					</span></font>
				</div>
				<!-- padding --><div style="height: 40px; line-height: 40px; font-size: 10px;"> </div>
			</td></tr>
 ...
 <p itemprop="email">Company Name</p>
                                        <p itemprop="email">STN No</p>
                                        <p itemprop="email">NTN no</p>
<p itemprop="email">Address</p>
                                        <p itemprop="email">Corresponding Address</p>
                                        <h2> <span itemprop="name">Product Name</span></h2>
                                        <p><span itemprop="affiliation">Order Id</span></p>
                                        ...
                                        <p><span itemprop="affiliation">Mode of Shipment</span></p>
                                        <p><span itemprop="affiliation">Mode of Payment</span></p>
									</div>
								</td>
								<td>
                                    <div istyle=" width:50%; height:auto; float:left font-family: Arial, Helvetica, sans-serif; font-size: 15px;">
                                    	<h2> <span>{{$customer_name}}</span></h2>
                                        <p>{{$customer_email}}</p>
                                        <p>{{$customer_city}}</p>
                                        <p>{{$customer_phone}}</p>
...
<p>{{$customer_address}}</p>
                                        <p>{{$customer_corresponding_address}}</p>
                                        <h2> <span>{{$product_name}}</span></h2>
                                        <p>{{$product_id}}</p>
                                        <p>{{$product_gsm}}</p>
                                        <p>{{$product_color}}</p>
                                        <p>{{$product_weave}}</p>
			...
			<tr><td >
				<div style="line-height: 24px;">
						<font face="Arial, Helvetica, sans-seri; font-size: 13px;" size="3" color="#596167">
							<span  style="font-family: Arial, Helvetica, sans-serif; font-size: 15px; color: #57697e;">KAMRAN ANWAR<br>
FAIRLINE SILK FACTORY<br>
0300-8481078<br>
Katar Bund Road,<br>
Thokar Niaz Baig<br>
Lahore
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					2018 © King Fabrics. ALL Rights Reserved.
				</span></font>				
			</td></tr>			
		</table>
