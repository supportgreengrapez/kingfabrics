...
<div class="man_intro  man_image_bck" data-image="{{url('/')}}/client/images/textile_main_image.jpg" data-color="#333333" data-repeat="no-repeat" data-position="center center" data-attachment="" data-size="cover">
  ...
  <div class="man_intro_cont">
    ...
    <div class="breadcrumbs" typeof="BreadcrumbList">
      ...
      <li class="archive taxonomy product_cat current-item"><span property="itemListElement" typeof="ListItem"><span property="name">Our Product</span>
          ...
          <div class="content-area">
            <div id="primary" class="content-area">
              <main id="main" class="site-main" role="main">
                ...
                <div class="stm-products-main grid">
                @if($result>0)
                  ...
                  <div class="stm-product-item"> <a class="stm-product-item__image content" href="#"> <img src="{{url('/')}}/client/images/Fotolia_58165627_Subscription_Monthly_M.jpg" alt="Chambray Quilted Quilt Cover &#8211; Dove"/> </a>
                    ...
                    <div class="stm-product-item__content">
                      <div class="meta-top">
                        ...
                        <a class="stm-product-item__title" href="{{URL('/')}}/sample/detail/view/{{$results->pk_id}}">{{$results->description}}</a></div>
          ...
          <div class="man_sidebar">
            <section id="woocommerce_product_categories-3" class="widget woocommerce widget_product_categories">
              ...
              <ul class="product-categories">
                <li class="cat-item cat-item-23 current-cat"><a href="{{URL('/')}}/sample/{{$results->category}}">{{$results->category}}</a> <span class="count">(6)</span></li>
              </ul>
              @endforeach
              @endif </section>
          </div>
